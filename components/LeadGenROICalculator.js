...
export default function LeadGenROICalculator() {
  ...
  const labels = {
    serviceFeeA: <span className='text-red-400'>"Expensive Monthly Retainer (Old Way - Lower Profits)"</span>,
        ...
        <CardContent className="py-6 text-white">
          ...
          {results?.boost && (
            <div className="mt-6 p-4 bg-green-900 rounded-lg text-white shadow border border-green-600">
              <p className="text-lg font-semibold mb-2">It's a no brainer! 🚀</p>
          ...
          {results?.serviceFeeA && (
            <div className="mt-6 p-4 bg-yellow-400 rounded-lg text-black border border-yellow-600 shadow">
              <p className="text-lg font-bold">💸 Money That Stays In Your Pocket Every Year</p>
              <p>
